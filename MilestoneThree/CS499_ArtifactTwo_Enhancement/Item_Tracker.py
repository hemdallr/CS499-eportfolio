"""
CS499 Capstone Artifact Two

Original Project: 
C++ item tracker

Enhancements:
Improving algorithm from O(log n) to O(1) with hash table based dictionary and improving code.
"""
...
class ItemTracker:
    ...
    # Added helper function for reusability and maintainability
        ...
        try:
             with open(file_name, 'r') as input_file:
                  for item in input_file:
                       ...
                       # Used hash table based dictionary to update item frequency 
                       # This has an average O(1) lookup compared to the C++ map using O(log n) 
    ...
    def save_file(self, file_name):
        ...
        # Switched to OSError because Exception was to broad.
        # OSError handles more specific faluires involving the OS. 
        except OSError:
            print(f"Could not open file: {file_name}")
...
def main():
    ...
    while True:
        ...
        if choice == 1:
            ...
            print(f"The frequency of {item.title()} is {frequency}")
